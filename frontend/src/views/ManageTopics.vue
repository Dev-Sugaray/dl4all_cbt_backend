          ...
          <table class="table table-bordered table-striped table-hover bg-white mb-0">
            <thead class="table-light">
              <tr>
                ...
                <th scope="col" class="small py-2">Topic Name</th>
            ...
            <tbody>
              <tr v-for="(topic, idx) in topics" :key="topic.topic_id">
                ...
                <td class="align-middle small">{{ topic.subject_name }} ({{ topic.subject_code }})</td>
...
import { getTopics } from '../services/topicService'; // Import from new service
